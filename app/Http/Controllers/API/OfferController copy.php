...
class OfferController extends BaseController
{
    public function getoffers(): JsonResponse {
        // $offersfree = Offer::where('deleted', '<>', '1')->with(['business','enjoys'])->get();
    ...
    public function sendStadistics() {
        ...
        // $data["email"] = "info@tarjetafanky.com.es";
        // $data["email"] = "raul.reyesman@gmail.com";
    ...
    public function newOffer(Request $request) {
        ...
        // $offer->image = "https://tarjetafanky.com.es/fankyapiapp/resources/images/1.jpg";
        ...
        if ($request->hasFile('image')) {
            ...
            // $nameImagen = $_FILES['image']['name']; // . '.' . $imagen->getClientOriginalExtension();
            ...
            // $offer->image = "https://tarjetafanky.com.es/fankyapiapp/public/images/" . $imagen->getClientOriginalName();



            // // $nombreImagen = time() . '.' . $imagen->getClientOriginalExtension();
            // $nombreImagen =($_FILES['image']['tmp_name']);
            // $nombreRutaImagen = "https://tarjetafanky.com.es/fankyapiapp/storage/app/offers/" . $imagen->getClientOriginalName();
            // // $rutaImagen = public_path('photos/') . $nombreImagen;

            // $rutaImagen = Storage::putFile('offers', $request->file('image'));
            // $targetPath = 'offers/';
            // $targetPath = $targetPath . basename($_FILES['image']['name']);
            // // ($imagen->getRealPath(),$rutaImagen);
            // // move_uploaded_file($nombreRutaImagen, $targetPath);
            // copy($nombreRutaImagen, $targetPath);
            // $offer->image = $nombreRutaImagen; // Almacenar la ruta relativa a la imagen
        }
